...
//---------------------------------
Yobit.prototype.addTrades = function addTrades(callback, pair, type, amount, rate)
{

    this.privateRequest('Trade', {
        pair: pair,
        type: type,
        rate: rate,
        amount: amount
...
//------------
Yobit.prototype.getActiveOrders = function getOrderInfo(callback, pair)
{
    this.privateRequest('ActiveOrders', {
        pair: pair
...
Yobit.prototype.getMyOrderInfo = function getOrderInfo(callback, order_id)
{
